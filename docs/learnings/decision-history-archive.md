...
This file contains the full detail of archived decisions from `decision-history.md`, preserved for reference. The main decision-history file retains foundational decisions and recent active decisions in full detail, with a compact summary table for archived entries.

> **Note:** This file is a reference archive. Do not read it routinely. Only consult it when you need the specific rationale, alternatives considered, or trade-offs for an archived decision.

Archived on 2026-03-21 as part of OLI-196 (context compression).
